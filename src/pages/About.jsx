...
const About = () => {
  return (
    <section className='max-container'>
      ...
      <div className='sm:h-[500px] h-[80vh] my-[15%] sm:my-[5%] flex flex-col sm:flex-row-reverse text-center sm:text-left sm:gap-[10%] gap-[1%]'>
        <div className="sm:w-[50%] h-[100%] flex flex-col items-start justify-center">
          ...
          I'm a self-taught developer proficient in frontend and backend development. With 4 years of coding experience, I specialize in creating visually appealing interfaces, implementing dynamic features, and integrating databases. I am passionate about website development and constantly stay updated with industry trends. I am ready to exceed client expectations and contribute to organizational success.
          </p> 
        </div>
        
        {meStuffs.map((meStuff) => (
          <div className="relative sm:w-[50%] h-[100%] flex items-center justify-center overflow-hidden bg-slate-300/20 rounded-3xl">
            <img src={meStuff.imageUrl} alt="Hello" className='h-full w-full object-cover' />
          </div>
        ))}
      </div>
              ...
              {experiences.map((experience) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className='text-black-500 font-medium font-base' style={{margin:0}}>{experience.name}</p>
                  </div>
