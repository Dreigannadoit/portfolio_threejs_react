...
const Navbar = () => {
  return (
    <header className="fixed z-50 w-screen h-[15%] bg-sky-500/[0] flex flex-row pr-[7%] pl-[7%] justify-between align-middle items-center">
      {meStuffs.map((meStuff) => (
          <NavLink to="/" className="w-25 h-full rounded-lg flex items-center justify-center gap-2 p-7">
